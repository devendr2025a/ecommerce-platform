...
// Men's shirts and formal pants images (excluding T-shirts)
...
async function uploadMensShirtsPantsRange() {
  const uploadedImages = [];

  console.log('📤 Uploading Men\'s Shirts & Formal Pants (₹2,000-₹3,800 range)...\n');
...
async function main() {
  try {
    await uploadMensShirtsPantsRange();
    process.exit(0);
  } catch (error) {
