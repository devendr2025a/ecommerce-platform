      ...
      <section className="py-14 sm:py-20 px-4 bg-[var(--vg-gray)] border-b border-[var(--vg-border)]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-black text-[var(--vg-black)] uppercase tracking-[0.08em] hover:text-[var(--vg-red)] transition-colors cursor-pointer">Wholesale & Bulk Orders</h2>
            <p className="text-sm text-[var(--vg-muted)] mt-3 max-w-2xl mx-auto">
          ...
          {/* Why Partner */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Why Partner with Avrotide?</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={item} className="flex items-center gap-2 text-xs font-bold text-[var(--vg-black)] cursor-pointer hover:translate-x-1 transition-transform duration-300 group">
                  <CheckCircle2 className="h-3 w-3 text-[var(--vg-red)] group-hover:scale-110 transition-transform" />
                  <span className="group-hover:text-[var(--vg-red)] transition-colors">{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Who Can Partner */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Who Can Partner With Us?</h3>
          ...
          {/* Wholesale Benefits */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Wholesale Benefits</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {WHOLESALE_BENEFITS.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex items-start gap-3 p-4 bg-white border border-[var(--vg-border)] cursor-pointer hover:border-[var(--vg-red)] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
          ...
          {/* MOQ Table */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Minimum Order Quantity (MOQ)</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
            ...
            <p className="text-[10px] text-[var(--vg-muted)] mt-2 italic">MOQ may vary depending on design availability and customisation requirements.</p>
          </div>

          {/* Pricing Structure */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Wholesale Pricing Structure</h3>
            <div className="space-y-2">
              {[
                ...
                <div key={item.tier} className="flex items-center gap-3 p-3 bg-white border border-[var(--vg-border)] cursor-pointer hover:border-[var(--vg-red)] hover:shadow-md hover:translate-x-1 transition-all duration-300 group">
            ...
            <p className="text-[10px] text-[var(--vg-muted)] mt-2">Detailed pricing is shared upon inquiry to ensure a tailored approach based on your business needs and order volume.</p>
          </div>

          {/* Process */}
          <div className="mb-12">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-4 hover:text-[var(--vg-red)] transition-colors cursor-pointer">Order & Fulfilment Process</h3>
          ...
          {/* Agreement */}
          <div className="mb-12 p-6 bg-white border border-[var(--vg-border)] cursor-pointer hover:border-[var(--vg-red)] hover:shadow-lg transition-all duration-300">
            <h3 className="text-lg font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-3 hover:text-[var(--vg-red)] transition-colors">Wholesale Agreement & Policies</h3>
            <ul className="space-y-1 text-xs text-[var(--vg-muted)]">
          ...
          <div className="text-center p-8 bg-white border border-[var(--vg-border)] cursor-pointer hover:border-[var(--vg-red)] hover:shadow-xl transition-all duration-300 group">
            <h3 className="text-xl font-black text-[var(--vg-black)] uppercase tracking-[0.1em] mb-3 group-hover:text-[var(--vg-red)] transition-colors">How to Get Started</h3>
